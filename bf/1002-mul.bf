...
# block @ will store the result #block 1 will hold the value to multiply
...
#subtract 48 from each: 'e
# loop while block 2 1-8 adding the value of block 1 to block @ every time
# BLOCK 8
BLOCK 1
4
BLOCK 2
